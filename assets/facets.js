...
class PriceRange extends HTMLElement {
  constructor() {
    ...
    this.inputs.forEach((element) => {
      element.addEventListener('input', this.debounce(this.onRangeChange.bind(this), 200));
  ...
  onKeyDown(event) {
    ...
    const pattern = /^[0-9.,'\s]$/;
    const allowedKeys = ['Tab', 'Backspace', 'ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight', 'Delete', 'Escape'];
  ...
  submitForm() {
    ...
    if (form) {
      form.requestSubmit(); // Modern safe form submission
    }
  }
